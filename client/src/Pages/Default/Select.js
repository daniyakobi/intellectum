  ...
  return (
    <>
      <div className={`select form__select ${props.classes}`} onClick={ showSelect }>
        <input className='select__input' type="hidden" name={`${props.name}[]`} id={ props.id } defaultValue={value.value ? value.value : props.current} onChange={ props.handler } />
        ...
        <ul className="select__list animate__animated animate__fadeIn">
