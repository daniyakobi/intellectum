    ...
    <div className="login__user flex-row">
      ...
      <div className="login__user-menu popup">
        <ul className="flex-column">
          ...
          <li className="sidebar__item"><NavLink className="sidebar__link text-16 flex-row" to='/profile/feedback' ><img src={ feedbackIcon } alt="Обратная связь" /><span>Обратная связь</span></NavLink></li>
          <li className="sidebar__item"><NavLink className="sidebar__link text-16 flex-row" to='/profile/notifications' ><img src={ notificationsIcon } alt="Уведомления" /><span>Уведомления</span></NavLink></li>
